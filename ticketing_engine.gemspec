...
require "ticketing_engine/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |spec|
  spec.name        = "ticketing_engine"
  spec.version     = TicketingEngine::VERSION
  spec.authors     = ["Wes Reid"]
  spec.email       = ["bwreid@gmail.com"]
  spec.homepage    = "https://github.com/WikiEducationFoundation/TicketingEngine"
